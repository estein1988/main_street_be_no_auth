class FinancialsController < ApplicationController
  ...
  private
    ...
    def financial_params
      params.require(:financial).permit(:year, :sales_revenue, :service_revenu, :advertising, :cogs, :employee_benefits, :equipment, :insurance, :maintenance, :office_supplies, :rent, :r_and_d, :salaries, :software, :travel, :utilities, :website, :other_expense, :interest, :taxes, :ammoritization, :depreciation, :business_id)
    end
end
